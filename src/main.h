...
void slideshow_mode(){
    ...
    while(0x1){
        ...
        case 0:
            ...
            break;
        case 1:
            read_and_show_565format_image(SD, "/imgs/img1.bin", POINT<>(0,0), 172, 220);
            break;
        case 2:
            read_and_show_565format_image(SD, "/imgs/img2.bin", POINT<>(0,0), 172, 220);
            break;
        case 3:
            read_and_show_565format_image(SD, "/imgs/img3.bin", POINT<>(0,0), 172, 220);
            break;
        }
        img_pos = (img_pos < 3)?(img_pos+1):0;
        if(sel != 0){
            /// show title
